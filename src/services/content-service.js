const content = {
  home: [{
    title: 'Reduce',
    template: `<p>By leveraging the web platform itself, code can be more portable, maintainable, and compatible.  Reducing external dependencies
    ...
    title: 'Reuse',
    template: `<p>Component based development has become a widely adopted and pragmatic option for approaching UI development and lends itself nicely to
    ...
    title: 'Recycle',
    template: `It should be clear, the JavaScript community and ecosystem is amazing and inspiring! There are so many wonderful tools and options out there, and that's what
